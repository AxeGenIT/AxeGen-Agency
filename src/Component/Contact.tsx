        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus && (
                <div
                  className={`mt-4 p-3 rounded-lg text-center ${submitStatus.success ? "bg-green-900/30 text-green-400" : "bg-red-900/30 text-red-400"}`}
                >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">
                      Proven track record in delivering high-impact digital
                      solutions
                    </p>
                  </div>
                </div>
