    ...
    <div className="flex items-center justify-around">
      ...
      <div className="md:w-[45%] w-full space-y-5">
        <div className="space-x-2">
          <span className=" bg-[#13CAFF] py-2 px-4 rounded-full font-semibold text-sm">
            Job Finder
          </span>
          <span className="bg-[#D733E3] py-2 px-4 rounded-full font-semibold text-sm ">
            Web development
          </span>
        </div>
        <div className="space-y-2">
          ...
          <p className="text-lg text-[#c7d2fe] leading-relaxed">
            ...
            voluptatem enim at! Placeat, aperiam aut nam magni ut eveniet.
          </p>
        </div>
        <div className="space-y-2">
